...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MashingTempLog.mashingschemeitem_started'
        db.alter_column('brew_mashingtemplog', 'mashingschemeitem_started_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['brew.MashingSchemeItem'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MashingTempLog.mashingschemeitem_started'
        raise RuntimeError("Cannot reverse this migration. 'MashingTempLog.mashingschemeitem_started' and its values cannot be restored.")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Variable.key'
        db.alter_column('brew_variable', 'key', self.gf('django.db.models.fields.CharField')(max_length=127))

    def backwards(self, orm):

        # Changing field 'Variable.key'
        db.alter_column('brew_variable', 'key', self.gf('django.db.models.fields.CharField')(max_length=25))
